...
class PhoneModel(models.Model):
    ...
    phone_number = models.CharField(primary_key=True, max_length=15, unique=True, validators=[phone_regex], default= '+999999999')

    def __unicode__(self):
        return u'%s' % self.phone_number

class NawenuzeGroup(models.Model):
    name = models.CharField(primary_key=True, max_length=60, default="Anonymous_group")
