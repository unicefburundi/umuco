...
urlpatterns = [
    ...
    url(
        r"^overview/(?P<colline>[0-9a-zA-Z_-]+)$",
        views.get_reports,
    ...
    # for the api
    url(
        r"^group/(?P<colline>[0-9a-zA-Z_-]+)/reports$",
        NawenuzeGroupReportList.as_view(),
        name="groupreport-list",
    ),
    url(
        r"^group/(?P<colline>[0-9a-zA-Z_-]+)$",
        NawenuzeGroupDetail.as_view(),
        name="group-detail",
    ),
    url(
        r"^group/details/(?P<group>[0-9a-zA-Z_-]+)$",
        views.by_group,
        name="group_detail",
    ),
    ...
    url(
        r"^reports/(?P<pk>\d+)$",
        views.NaweNuzeDetail.as_view(),
        name="reports_by_groups",
    ),
