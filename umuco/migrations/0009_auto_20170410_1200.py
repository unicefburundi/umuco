...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='phonemodel',
            name='number',
            field=models.CharField(max_length=15, unique=True, serialize=False, verbose_name='phone number', primary_key=True),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.PositiveIntegerField(default=0, verbose_name='Recharged lamps'),
        ),
        migrations.AlterField(
            model_name='report',
            name='sold_lamps',
